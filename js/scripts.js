...
mr = (function (mr, $, window, document){
    ...
    mr.sliders.documentReady = function($){
        ...
        $('.slider').each(function(index){
            ...
            ao.imagesLoaded = slider.attr('data-imagesloaded') === "true" ? true: undefined;
            ao.lazyLoad = slider.attr('data-lazyload') === "true" ? true: undefined;
            ...
            $(sliderInitializer).flickity('resize');
